<template>
    ...
    <div class="col-lg-5 d-lg-block d-none">
                    ...
                    <div class="row border bg-white position-relative">
                        <ul id="maintext" class="col-12 bar border-primary"
                            ...
                            <li class="row d-flex justify-content-start pt-5 pb-3">
                                ...
                                <div class="col d-flex flex-column align-items-start">
                                    <span>test-2:</span>
                                    <div class="p-2 m-2 rounded-3 textBg textLeft position-relative"
                                        style="max-width: 70%">騙人的吧</div>
                                </div>
                            </li>
                            <!-- ----- -->
                            <li class="d-flex justify-content-end pt-4 pb-3 position-relative">
                            ...
                            <li class="row d-flex justify-content-start pt-5 pb-3">
                                ...
                                <div class="col d-flex flex-column align-items-start">
                                    <span>test-6:</span>
                                    <div class="p-2 m-2 rounded-3 textBg textLeft position-relative"
                                        style="max-width: 70%">(σ′▽‵)′▽‵)σ 哈哈哈哈～UCCU</div>
                                </div>
                            </li>
                            <!-- ----- -->
                            <li class="d-flex justify-content-end pt-4 pb-3 position-relative">
                        ...
                        <div class="d-grid gap-2 position-absolute start-0 top-100 translate-middle ms-4"
                            ...
                            <a class="btn position-absolute start-50 top-50" role="button">
                                ...
                                <label for="upload" class="position-absolute start-0 top-50 translate-middle"
                                    style="cursor: none;">
                                    <input style="opacity: 0; max-width: 28px;" id="upload" type="file"
        ...
        <section class="container bg-primary p-1 mt-1">
            <div class="row d-flex justify-content-center">
                <section class="col-12 rounded-3">
                    <div class="input-group px-0">
                        <textarea id="usertext" class="form-control" aria-label="With textarea"
                            style="box-shadow: none; resize:none;" placeholder="開始吵鬧吧~"></textarea>
                        <button onclick="submit()" class="input-group-text bg-white" type="submit"><span
