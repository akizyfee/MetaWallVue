                ...
                <div class="card mb-3 border8px border-2 cardDashBoard">
                    <div class="row g-0 px-4">
                        <div class="col-2 col-lg-1 align-self-center">
                            <img src="@/assets/img/user6.png" class="img-fluid rounded-start d-block m-auto"
                                alt="user6">
                        </div>
                        <div class="col-10 col-lg-11 d-flex justify-content-between">
                            <div class="card-body">
                                <h5 class="card-title fw-bold">阿爾敏</h5>
                                <p class="card-text"><small class="text-muted">987,987 人追蹤</small></p>
                            </div>
                            <button type="button"
                ...
                <ul class="ps-0">
                    ...
                    <li class="card h-100 py-4 px-4 mb-3 border-2 shadow-pushcard border8px">
                        <div class="d-flex align-items-center mb-3">
                            <img class="me-3 img-fluid" src="@/assets/img/user6.png" alt="user6" />
                        ...
                        <!-- -add--message--- -->
                        <div class="d-flex mt-3">
                            <img src="@/assets/img/user6.png" alt="usr6" class="img-fluid me-1" />
                            ...
                            <ul class="card card-body border-0">
                                <li class="card h-100 p-3 border-0 rounded-3 mt-3 bg-gray-light">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <button class="btn btn-primary rounded-0" type="button" id="content">OK</button>
                                    </div>
                                </li>
                                <!-- ------------- -->
                                <li class="card h-100 p-3 border-0 rounded-3 mt-3 bg-gray-light">
                        ...
                        <div class="d-flex mt-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control text-dark border-dark border-2 border-end-0"
                                    placeholder="" value="這邊淹水" aria-label="message"
                    ...
                    <li class="card h-100 py-4 px-4 mb-3 border-2 shadow-pushcard border8px">
                        ...
                        <div class="d-flex mt-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control text-dark border-dark border-2 border-end-0"
                                    placeholder="" value="......." aria-label="message"
                                    aria-describedby="button-message" />
                                <button class="btn btn-warning px-4 rounded-0 border-dark border-2 fw-bold"
                                    type="button" id="button-message">
                                    留言
